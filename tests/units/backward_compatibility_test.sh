...
CORE_VERSION="$(echo "$CHART_VERSION" | sed 's/[-+].*$//')"
CURRENT_MAJOR="$(echo "$CORE_VERSION" | cut -d. -f1)"
CURRENT_MINOR="$(echo "$CORE_VERSION" | cut -d. -f2)"
CURRENT_PATCH="$(echo "$CORE_VERSION" | cut -d. -f3)"
